              ...
              <Card className="shadow-sm rounded-xl border-dashed">
                <CardContent className="flex flex-col items-center justify-center py-10 text-center">
                  ...
                  <p className="text-[14px] text-muted-foreground mt-1">
                    Supervisors will add farmers here
                  </p>
                </CardContent>
              </Card>
            ) : (
      ...
      <Card className="shadow-sm rounded-xl overflow-hidden">
        ...
        <CardContent className="p-4 sm:p-6 space-y-5">
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <Shield
                className={`size-6 mb-2 ${role === "supervisor" ? "text-primary" : "text-muted-foreground"}`}
              />
            ...
            >
              <Tractor
                className={`size-6 mb-2 ${role === "farmer" ? "text-primary" : "text-muted-foreground"}`}
              />
          ...
          <Button
            className="w-full h-[52px] rounded-lg text-[16px] font-bold shadow-md active:scale-[0.99] transition-transform"
            onClick={submit}
            disabled={busy}
          >
            {busy ? (
