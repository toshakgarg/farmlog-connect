...
export const strings: Dict = {
  ...
  newFarmerRecord: { en: "New Farmer Record", hi: "नया किसान रिकॉर्ड" },
  fillJoitaForm: { en: "Fill JOITA Form", hi: "JOITA प्रपत्र भरें" },
  scanPaperForm: { en: "Scan Paper Form", hi: "पेपर फॉर्म स्कैन करें" },
  feature1: { en: "Geotagged farm photos", hi: "जियोटैग्ड खेत फोटो" },
  feature2: { en: "Digital farmer records", hi: "डिजिटल किसान रिकॉर्ड" },
  feature3: { en: "Works offline, syncs automatically", hi: "ऑफलाइन काम करे, अपने आप सिंक हो" },
  step: { en: "Step", hi: "चरण" },
  of: { en: "of", hi: "में से" },
  adminPanel: { en: "Admin Panel", hi: "एडमिन पैनल" },
  farmerRecords: { en: "Farmer Records", hi: "किसान रिकॉर्ड" },
  joitaForms: { en: "JOITA Forms", hi: "JOITA प्रपत्र" },
  allSupervisors: { en: "All Supervisors", hi: "सभी पर्यवेक्षक" },
  exportAll: { en: "Export All (CSV)", hi: "सभी डाउनलोड करें" },
  noRecordsFound: { en: "No records found", hi: "कोई रिकॉर्ड नहीं मिला" },
  createUser: { en: "Create User", hi: "उपयोगकर्ता बनाएं" },
  next: { en: "Next", hi: "अगला" },
  home: { en: "Home", hi: "होम" },
  profile: { en: "Profile", hi: "प्रोफाइल" },
  users: { en: "Users", hi: "उपयोगकर्ता" },
  settings: { en: "Settings", hi: "सेटिंग्स" },
  recordsThisWeek: { en: "Records This Week", hi: "इस सप्ताह रिकॉर्ड" },
  placeFormOnFlatSurface: { en: "Place form on flat surface", hi: "फॉर्म को समतल जगह पर रखें" },
  ensureGoodLighting: { en: "Ensure good lighting", hi: "पर्याप्त रोशनी सुनिश्चित करें" },
  fullFormMustBeInFrame: { en: "Full form must be in frame", hi: "पूरा फॉर्म कैमरे में आना चाहिए" },
  bothHindiAndEnglishAreRead: { en: "Both Hindi and English are read", hi: "हिंदी और अंग्रेजी दोनों पढ़ी जा सकती हैं" },
  correctMistakes: { en: "You can correct any mistakes in the form", hi: "आप फॉर्म में जाकर गलत जानकारी सुधार सकते हैं" },
  reviewInForm: { en: "Review in Form", hi: "फॉर्म में देखें" },
  scanAgain: { en: "Scan Again", hi: "दोबारा स्कैन करें" },
  tryAgain: { en: "Try Again", hi: "दोबारा कोशिश करें" },
  pleaseGiveConsent: { en: "Please give consent", hi: "कृपया सहमति दें" },
  baseline: { en: "Baseline", hi: "आधार रेखा" },
  followUp: { en: "Follow-up", hi: "अनुवर्ती" },
  scanPaperFormHeader: { en: "Scan Paper Form", hi: "पेपर फॉर्म स्कैन करें" },
  scanFailed: { en: "Scan Failed", hi: "स्कैन विफल" }
};
